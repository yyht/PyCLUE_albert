...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "electra_official_electra_final"
	configs["vocab_file"] = "/data/albert/electric_chinese_base/vocab.txt"
	configs["bert_config_file"] = "/data/albert/chinese_electra_base_L-12_H-768_A-12/bert_config.json"
	configs["init_checkpoint"] = "/data/albert/chinese_electra_base_L-12_H-768_A-12/model.ckpt-1000000"
	configs["verbose"] = 1
