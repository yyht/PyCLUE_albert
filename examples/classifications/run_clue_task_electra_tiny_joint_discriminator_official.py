...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "electra_v1_v1_official_tiny_discriminator"
	configs["vocab_file"] = "/data/tiny/chinese_electra_tiny_nucleus/vocab.txt"
	configs["bert_config_file"] = "/data/tiny/chinese_electra_tiny_nucleus/bert_config_tiny.json"
	configs["init_checkpoint"] = "/data/tiny/chinese_electra_tiny_nucleus/model.ckpt-150000"
	configs["verbose"] = 1
