...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "roberta_conv_bert_small_electra_5_new"
	configs["vocab_file"] = "/data/albert/robert_conv_small_5_new/vocab.txt"
	configs["bert_config_file"] = "/data/albert/robert_conv_small_5_new/bert_config_small_conv_v1.json"
	configs["init_checkpoint"] = "/data/albert/robert_conv_small_5_new/conv_small_chinese_5_model.ckpt-1000000"
	configs["verbose"] = 1
