...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "roberta_tiny_span_mask_conv_9"
	configs["vocab_file"] = "/data/albert/conv_bert_tiny_9/vocab.txt"
	configs["bert_config_file"] = "/data/albert/conv_bert_tiny_9/bert_config_tiny_conv.json"
	configs["init_checkpoint"] = "/data/albert/conv_bert_tiny_9/conv_roberta_small_model.ckpt-145800"
	configs["verbose"] = 1
