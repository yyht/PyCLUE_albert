...
for task_name in FLAGS.task_name.split(","):
	...
	configs["vocab_file"] = "/data/xuht/bert_tiny_with_single_random_adam_decay_40/vocab.txt"
	configs["bert_config_file"] = "/data/xuht/bert_tiny_with_single_random_adam_decay_40/bert_config_tiny.json"
	configs["init_checkpoint"] = "/data/xuht/bert_tiny_with_single_random_adam_decay_40/model.ckpt-1145800"
	configs["verbose"] = 1
