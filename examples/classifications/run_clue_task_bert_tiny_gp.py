...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "roberta_tiny_span_mask_vat_gp_l2_10"
	configs["vocab_file"] = "/data/tiny/roberta_tiny_span_mask_vat_l2_10/vocab.txt"
	configs["bert_config_file"] = "/data/tiny/roberta_tiny_span_mask_vat_l2_10/bert_config_tiny.json"
	configs["init_checkpoint"] = "/data/tiny/roberta_tiny_span_mask_vat_l2_10/model.ckpt-220000"
	configs["verbose"] = 1
