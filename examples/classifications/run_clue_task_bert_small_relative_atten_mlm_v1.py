...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "funnel_transformer_small_v1_relative_attn_mlm"
	configs["vocab_file"] = "/data/roberta_small_span_mask_relative_attn/vocab.txt"
	configs["bert_config_file"] = "/data/roberta_small_span_mask_relative_enc_dec_mlm//net_config_small_chinese_enc_dec_no_skip_denoise_mlm.json"
	configs["init_checkpoint"] = "/data/roberta_small_span_mask_relative_enc_dec_mlm/model.ckpt-1145800"
	configs["verbose"] = 1
