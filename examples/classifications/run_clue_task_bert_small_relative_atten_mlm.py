...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "funnel_transformer_small_v1_relative_attn_med"
	configs["vocab_file"] = "/data/roberta_small_span_mask_relative_attn/vocab.txt"
	configs["bert_config_file"] = "/data/roberta_small_span_mask_relative_attn/net_config_small_chinese.json"
	configs["init_checkpoint"] = "/data/roberta_small_span_mask_relative_attn/model.ckpt-520000"
	configs["verbose"] = 1
