...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "funnel_transformer_small_enc_dec_v2_relative_attn"
	...
	configs["init_checkpoint"] = "/data/roberta_small_span_mask_relative_enc_dec_no_skip/v2_model.ckpt-1145800"
	configs["verbose"] = 1
