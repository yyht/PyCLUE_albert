...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "roberta_small_span_mask_strucutral_attention"
	configs["vocab_file"] = "/data/roberta_small_strutural_attention/vocab.txt"
	configs["bert_config_file"] = "/data/roberta_small_strutural_attention/bert_config_small_structural_attention.json"
	configs["init_checkpoint"] = "/data/roberta_small_strutural_attention/structural_attention_v1_model.ckpt-613000"
	configs["verbose"] = 1
