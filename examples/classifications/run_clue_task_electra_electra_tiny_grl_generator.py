...
model_name = "bert_electra_tiny_generator_scratch"
...
for task_name in FLAGS.task_name.split(","):
	...
	configs["verbose"] = 1
	configs["pretrained_lm_name"] = model_name+"_discriminator_569000"
	configs["vocab_file"] = os.path.join("/data", vocab_path, "discriminator", "vocab.txt")
	configs["bert_config_file"] = os.path.join("/data", config_path, "discriminator", "bert_config_tiny.json")
	configs["init_checkpoint"] = os.path.join("/data", config_path, "discriminator", "discriminator-569000")
