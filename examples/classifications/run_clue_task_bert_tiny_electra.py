...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "roberta_tiny_span_mask_electra"
	configs["vocab_file"] = "/data/tiny/roberta_tiny_span_mask_electra/vocab.txt"
	configs["bert_config_file"] = "/data/tiny/roberta_tiny_span_mask_electra/bert_config_tiny.json"
	configs["init_checkpoint"] = "/data/tiny/roberta_tiny_span_mask_electra/model.ckpt-859370"
	configs["verbose"] = 1
