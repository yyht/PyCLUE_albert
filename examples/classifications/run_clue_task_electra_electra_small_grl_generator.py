...
for task_name in FLAGS.task_name.split(","):
	...
	configs["verbose"] = 1
	configs["pretrained_lm_name"] = model_name+"_small_generator_grl_50"
	configs["vocab_file"] = os.path.join("/data", vocab_path, "generator", "vocab.txt")
	configs["bert_config_file"] = os.path.join("/data", config_path, "generator", "bert_config_small.json")
	configs["init_checkpoint"] = os.path.join("/data", config_path, "generator", "generator.ckpt-1289000")
