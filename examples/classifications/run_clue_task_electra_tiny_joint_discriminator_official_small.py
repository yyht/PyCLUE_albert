...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "electra_official_small_discriminator_gp"
	configs["vocab_file"] = "/data/chinese_electra_small_L-12_H-256_A-4/vocab.txt"
	configs["bert_config_file"] = "/data/chinese_electra_small_L-12_H-256_A-4/bert_config_small.json"
	configs["init_checkpoint"] = "/data/chinese_electra_small_L-12_H-256_A-4/model.ckpt-1000000"
	configs["verbose"] = 1
