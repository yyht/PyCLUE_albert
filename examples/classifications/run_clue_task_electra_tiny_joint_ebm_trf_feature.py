...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "bert_tiny_ebm_residual_tiny_cls_feature"
	configs["vocab_file"] = "/data/ebm_trf/ebm_residual_tiny_cls/vocab.txt"
	configs["bert_config_file"] = "/data/ebm_trf/ebm_residual_tiny_cls/bert_config_tiny.json"
	configs["init_checkpoint"] = "/data/ebm_trf/ebm_residual_tiny_cls/model.ckpt-42968"
	configs["verbose"] = 1

	configs["do_train"] = True
	configs["do_eval"] = True
	configs["do_predict"] = True
	configs["whole_or_feature"] = "feature"
