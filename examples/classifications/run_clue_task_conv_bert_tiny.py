...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "roberta_tiny_modified_conv_bert_tiny_9"
	configs["vocab_file"] = "/data/albert/modified/conv_bert_tiny_9/vocab.txt"
	configs["bert_config_file"] = "/data/albert/modified/conv_bert_tiny_9/bert_config_tiny_conv.json"
	configs["init_checkpoint"] = "/data/albert/modified/conv_bert_tiny_9/conv_roberta_tiny_9_model.ckpt-1145800"
	configs["verbose"] = 1
