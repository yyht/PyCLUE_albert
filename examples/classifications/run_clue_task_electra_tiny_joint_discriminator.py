...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "bert_electra_tiny_discriminator_1074200"
	configs["vocab_file"] = "/data/joint/electra_bert_tiny_gen_bert_tiny_dis_joint_no_sharing_pretrained_embedding/discriminator/vocab.txt"
	configs["bert_config_file"] = "/data/joint/electra_bert_tiny_gen_bert_tiny_dis_joint_no_sharing_pretrained_embedding/discriminator/bert_config_tiny_large_embed.json"
	configs["init_checkpoint"] = "/data/joint/electra_bert_tiny_gen_bert_tiny_dis_joint_no_sharing_pretrained_embedding/discriminator/discriminator.ckpt-1074200"
	configs["verbose"] = 1
