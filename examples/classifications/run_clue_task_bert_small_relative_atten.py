...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "funnel_transformer_small_enc_dec_v1_relative_attn_med"
	configs["vocab_file"] = "/data/roberta_small_span_mask_relative_enc_dec_no_skip/vocab.txt"
	configs["bert_config_file"] = "/data/roberta_small_span_mask_relative_enc_dec_no_skip/net_config_small_chinese_enc_dec_no_skip.json"
	configs["init_checkpoint"] = "/data/roberta_small_span_mask_relative_enc_dec_no_skip/v1_model.ckpt-520000"
	configs["verbose"] = 1
