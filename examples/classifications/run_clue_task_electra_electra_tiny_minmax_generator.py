...
for task_name in FLAGS.task_name.split(","):
	...
	if task_name == 'afqmc':
		...
		configs["warmup_proportion"] = 0.1
		configs["num_train_epochs"] = 10.0
#	configs["warmup_proportion"] = 0.06
	# pretrained_lm_name: 
	...
	configs["pretrained_lm_name"] = "bert_tiny_electra_minmax_scale_10_none_sharing_generator"
	configs["vocab_file"] = "/data/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_none_sharing_adam_decay_alternate_real/generator/vocab.txt"
	configs["bert_config_file"] = "/data/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_none_sharing_adam_decay_alternate_real/generator/bert_config_tiny.json"
	configs["init_checkpoint"] = "/data/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_none_sharing_adam_decay_alternate_real/generator/generator"
	configs["verbose"] = 1
