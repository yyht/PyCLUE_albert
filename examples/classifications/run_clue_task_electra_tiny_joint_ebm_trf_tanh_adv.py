...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "bert_tiny_ebm_residual_tiny_cls_tanh_adv_piece"
	configs["vocab_file"] = "/data/ebm_adv_piece/vocab.txt"
	configs["bert_config_file"] = "/data/ebm_adv_piece/bert_config_tiny.json"
	configs["init_checkpoint"] = "/data/ebm_adv_piece/model.ckpt-128904"
	configs["verbose"] = 1
