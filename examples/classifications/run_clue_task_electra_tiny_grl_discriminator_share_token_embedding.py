...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "bert_grl_tiny_discriminator_1074200_share_token_embedding"
	configs["vocab_file"] = "/data/grl/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_sharing_pretrained_embedding_mixed_mask/discriminator/vocab.txt"
	configs["bert_config_file"] = "/data/grl/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_sharing_pretrained_embedding_mixed_mask/discriminator/bert_config_tiny_embed_sharing.json"
	configs["init_checkpoint"] = "/data/grl/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_sharing_pretrained_embedding_mixed_mask/discriminator/discriminator.ckpt-1074200"
	configs["verbose"] = 1
