...
#         albert_small, albert_tiny, roberta, roberta_wwm_ext, roberta_wwm_ext_large
    configs["pretrained_lm_name"] = "roberta_span_mask"
    configs["vocab_file"] = "/data/roberta_base_span_mask/vocab.txt"
    configs["bert_config_file"] = "/data/roberta_base_span_mask/bert_config.json"
    configs["init_checkpoint"] = "/data/roberta_base_span_mask/model.ckpt-1145800"
    configs["verbose"] = 1
