...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "funnel_transformer_roberta_tiny"
	configs["vocab_file"] = "/data/tiny/roberta_tiny_span_mask_relative_attn/vocab.txt"
	configs["bert_config_file"] = "/data/tiny/roberta_tiny_span_mask_relative_attn/net_config_tiny_chinese.json"
	configs["init_checkpoint"] = "/data/tiny/roberta_tiny_span_mask_relative_attn/model.ckpt-1145800"
	configs["verbose"] = 1
