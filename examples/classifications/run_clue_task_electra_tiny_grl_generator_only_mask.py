...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "bert_electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_generator_local_mask_600000"
	configs["vocab_file"] = "/data/grl/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_scale_10_grl_only_mask/generator/vocab.txt"
	configs["bert_config_file"] = "/data/grl/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_scale_10_grl_only_mask/generator/bert_config_tiny.json"
	configs["init_checkpoint"] = "/data/grl/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_scale_10_grl_only_mask/generator/generator.ckpt-600000"
	configs["verbose"] = 1
