...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "bert_tiny_ebm_residual_tiny_cls_gelu_1"
	configs["vocab_file"] = "/data/ebm_trf/ebm_residual_tiny_cls_gelu/vocab.txt"
	configs["bert_config_file"] = "/data/ebm_trf/ebm_residual_tiny_cls_gelu/bert_config_tiny.json"
	configs["init_checkpoint"] = "/data/ebm_trf/ebm_residual_tiny_cls_gelu/model.ckpt-42968"
	configs["verbose"] = 1
