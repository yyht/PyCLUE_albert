...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "bert_trf_ebm_tiny"
	configs["vocab_file"] = "/data/trf_ebm_chinese/vocab.txt"
	configs["bert_config_file"] = "/data/trf_ebm_chinese/bert_config_tiny.json"
	configs["init_checkpoint"] = "/data/trf_ebm_chinese/model.ckpt-210000"
	configs["verbose"] = 1
