...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "bert_electra_tiny_generator_1074200_sharing_embedding"
	configs["vocab_file"] = "/data/joint/electra_bert_tiny_gen_bert_tiny_dis_joint_sharing_pretrained_embedding/generator/vocab.txt"
	configs["bert_config_file"] = "/data/joint/electra_bert_tiny_gen_bert_tiny_dis_joint_sharing_pretrained_embedding/generator/bert_config_tiny_large_embed_sharing.json"
	configs["init_checkpoint"] = "/data/joint/electra_bert_tiny_gen_bert_tiny_dis_joint_sharing_pretrained_embedding/generator/generator.ckpt-1074200"
	configs["verbose"] = 1
