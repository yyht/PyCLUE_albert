...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "light_dgcnn_chinese_tiny"
	configs["vocab_file"] = "/data/tiny/light_conv_chinese_tiny_disc_bi/vocab.txt"
	configs["bert_config_file"] = "/data/tiny/light_conv_chinese_tiny_disc_bi/textcnn_chinese_emebdding_light_dgcnn_v1_bi_tiny.json"
	configs["init_checkpoint"] = "/data/tiny/light_conv_chinese_tiny_disc_bi/model.ckpt-976550"
	configs["verbose"] = 1
