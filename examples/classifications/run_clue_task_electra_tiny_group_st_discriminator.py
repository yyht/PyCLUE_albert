...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "bert_electra_tiny_group_st_discriminator_1074200_mixed_mask"
	...
	configs["bert_config_file"] = "/data/group/st/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_pretrained_embedding_mixed_mask/discriminator/bert_config_tiny_large_embed.json"
	configs["init_checkpoint"] = "/data/group/st/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_pretrained_embedding_mixed_mask/discriminator/discriminator.ckpt-1074200"
	configs["verbose"] = 1
