...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "roberta_tiny_span_mask_fixed_attention_headsize"
	configs["vocab_file"] = "/data/roberta_tiny_fixed_attention_head_size/vocab.txt"
	configs["bert_config_file"] = "/data/roberta_tiny_fixed_attention_head_size/bert_config_tiny_fixed_attention_size.json"
	configs["init_checkpoint"] = "/data/roberta_tiny_fixed_attention_head_size/model.ckpt-859360"
	configs["verbose"] = 1
