...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "bert_electra_bert_tiny_gen_bert_tiny_joint_gumbel_discriminator_local_mask_1"
	configs["vocab_file"] = "/data/grl/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_scale_1_grl_only_mask/discriminator/vocab.txt"
	configs["bert_config_file"] = "/data/grl/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_scale_1_grl_only_mask/discriminator/bert_config_tiny.json"
	configs["init_checkpoint"] = "/data/grl/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_scale_1_grl_only_mask/discriminator/discriminator.ckpt-1074200"
	configs["verbose"] = 1
