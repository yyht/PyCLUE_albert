...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "bert_electra_tiny_relgan_soft_generator_1074200_mixed_mask"
	configs["vocab_file"] = "/data/relgan/soft/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_pretrained_embedding_mixed_mask/generator/vocab.txt"
	configs["bert_config_file"] = "/data/relgan/soft/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_pretrained_embedding_mixed_mask/generator/bert_config_tiny_large_embed.json"
	configs["init_checkpoint"] = "/data/relgan/soft/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_pretrained_embedding_mixed_mask/generator/generator.ckpt-1074200"
	configs["verbose"] = 1
