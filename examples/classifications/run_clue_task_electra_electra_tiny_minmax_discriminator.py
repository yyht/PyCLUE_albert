...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "bert_tiny_electra_grl_scale_10_none_sharing_discriminator"
	configs["vocab_file"] = "/data/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_scale_10_grl_auto_temp_fix/discriminator/vocab.txt"
	configs["bert_config_file"] = "/data/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_scale_10_grl_auto_temp_fix/discriminator/bert_config_tiny.json"
	configs["init_checkpoint"] = "/data/electra_bert_tiny_gen_bert_tiny_dis_joint_gumbel_no_sharing_scale_10_grl_auto_temp_fix/discriminator/discriminator"
	configs["verbose"] = 1
