...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "bert_electra_official_tiny_gumbel_discriminator"
	configs["vocab_file"] = "/data/official/chinese/vocab.txt"
	configs["bert_config_file"] = "/data/official/chinese/electra_config_tiny.json"
	configs["init_checkpoint"] = "/data/official/chinese/model.ckpt-1074200"
	configs["verbose"] = 1
