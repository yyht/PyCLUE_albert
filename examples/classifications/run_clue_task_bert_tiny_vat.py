...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "roberta_tiny_span_mask_vat_pre_kl_v1"
	configs["vocab_file"] = "/data/tiny/roberta_tiny_span_mask_vat_pre_v1/vocab.txt"
	configs["bert_config_file"] = "/data/tiny/roberta_tiny_span_mask_vat_pre_v1/bert_config_tiny.json"
	configs["init_checkpoint"] = "/data/tiny/roberta_tiny_span_mask_vat_pre_v1/model.ckpt-50000"
	configs["verbose"] = 1
