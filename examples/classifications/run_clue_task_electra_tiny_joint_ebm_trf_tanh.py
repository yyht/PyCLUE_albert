...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "bert_tiny_ebm_residual_tiny_cls_tanh"
	configs["vocab_file"] = "/data/ebm_tiny_cls_residual_tanh/vocab.txt"
	configs["bert_config_file"] = "/data/ebm_tiny_cls_residual_tanh/bert_config_tiny.json"
	configs["init_checkpoint"] = "/data/ebm_tiny_cls_residual_tanh/model.ckpt-42968"
	configs["verbose"] = 1
