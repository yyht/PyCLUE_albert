...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "bert_joint_tiny_generator_1074200_share_token_embedding"
	configs["vocab_file"] = "/data/joint/electra_bert_tiny_gen_bert_tiny_dis_joint_sharing_pretrained_embedding_mixed_mask/generator/vocab.txt"
	configs["bert_config_file"] = "/data/joint/electra_bert_tiny_gen_bert_tiny_dis_joint_sharing_pretrained_embedding_mixed_mask/generator/bert_config_tiny_embed_sharing.json"
	configs["init_checkpoint"] = "/data/joint/electra_bert_tiny_gen_bert_tiny_dis_joint_sharing_pretrained_embedding_mixed_mask/generator/generator.ckpt-1074200"
	configs["verbose"] = 1
