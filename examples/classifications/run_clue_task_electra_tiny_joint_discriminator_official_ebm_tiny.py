...
for task_name in FLAGS.task_name.split(","):
	...
	configs["pretrained_lm_name"] = "electra_v1_tiny_ebm_discriminator"
	configs["vocab_file"] = "/data/chinese_electra_only_ebm/vocab.txt"
	configs["bert_config_file"] = "/data/chinese_electra_only_ebm/bert_config_tiny.json"
	configs["init_checkpoint"] = "/data/chinese_electra_only_ebm/model.ckpt-1000000"
	configs["verbose"] = 1
