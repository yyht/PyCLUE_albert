...
#         albert_small, albert_tiny, roberta, roberta_wwm_ext, roberta_wwm_ext_large
    configs["pretrained_lm_name"] = "roberta_ebm_base"
    configs["vocab_file"] = "/data/ebm_trf/ebm_residual_base_cls_gelu/vocab.txt"
    configs["bert_config_file"] = "/data/ebm_trf/ebm_residual_base_cls_gelu/bert_config.json"
    configs["init_checkpoint"] = "/data/ebm_trf/ebm_residual_base_cls_gelu/model.ckpt-85937"
    configs["verbose"] = 1
